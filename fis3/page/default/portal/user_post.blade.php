...
@section('content')
<div>
    <form class="form form-horizontal" role="form" action="/user/article/postadd">
        {!! csrf_field() !!}
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" min="6" max="15" required="required" name="title" placeholder="标题...">
            </div>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <textarea id="editor" name="content" placeholder="输入内容..." autofocus></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-5">
...
upload:{ url:'{{route('upload')}}?type=image_simditor&' },
pasteImage:true }); }); 
